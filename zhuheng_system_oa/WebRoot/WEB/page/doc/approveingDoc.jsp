				   ...
				   <c:otherwise>
				     <c:forEach items="${appingDocs}" var="flag">
				       <tr>
						...
						<td><a href="doc/doc_downloadDoc.action?doc_id=${flag.dom_id}">
							下载</a></td>
						<td><a href="javascript:void(openWindow('doc/doc_openApprovedHistory.action?doc_id=${flag.dom_id}',600,500,'openHistory'))">
							查看</a></td>
						<td><a href="javascript:void(openWindow('doc/doc_openApprove.action?doc_id=${flag.dom_id}',600,500,'open01'))">审批</a>
						/<a href="javascript:void(openWindow('doc/doc_openSubmitDoc.action?doc_id=${flag.dom_id}',600,500,'open01'))">提交</a></td>
				     </tr>
				     </c:forEach>
				   </c:otherwise>
				</c:choose>
