...
<legend>编辑员工信息</legend>
		<form method="POST" action="" id="form1" name="form1">
		    ...
		    <ul>
				...
				<li><label>员工编号：</label><input type="text" name="empNo" value="${emp.emp_sn}"></li>
				<li><label>员工姓名：</label><input type="text" name="empName" value="${emp.emp_name}"></li>
				<li><label>所属部门：</label><input type="text" name="deptName" value="${emp.dep.dep_name}"></li>
				<li><label>性  别：</label><input type="text" name="sex" value="${emp.emp_sex}"></li>
				<li><label>所任职务：</label><input type="text" name="job" value="${emp.emp_job}"></li>
				<li><label>联系电话：</label><input type="text" name="phone" value="${emp.emp_phone}"></li>
				<li><label>现所在住址：</label><input type="text" name="address" value="${emp.emp_address}" maxlength="120" style="width:400px;"></li>
