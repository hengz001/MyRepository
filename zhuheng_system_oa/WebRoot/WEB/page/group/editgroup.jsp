...
<html>
  ...
  <body>
    <div align="center">
    <form action="group/group_updateGroup.action" method="post" id="form01">
	<table width="300" height="120">
		...
		<tr>
			<td class="inputline" align="left">
				&nbsp;&nbsp;&nbsp;组名：
				<select name="g_id" class="textbox"> 
			...
			<tr>
			   <td class="inputline" align="left">
			   &nbsp;账号名：
			      <input type="hidden" name="u_id" value="<s:property value="#request.user.u_id"/>">
