...
<html>
  <head>
	...
	<script type="text/javascript">
		function u_submit(){
			document.getElementById("from01").submit();
		}
	</script>
  </head>
  ...
  <body>
	...
	<form action="user/user_addUser.action" method="post" id="from01">
		<tr>
		...
		<tr>
			...
			<input type="hidden" name="user.emp.emp_id" id="e_id" value=""/>
				姓名：<input type="text" name="user.emp.emp_name" style="width:80px" disabled="disabled" id="empName"/>
				<a href="javascript:void(openWindow('user/user_getEmps.action',800,410,'select'))">选择</a>
			</td>
		</tr>
		<tr>
